...
blogid;
BlogById;
  private list: {  blogid: number , blogname: string, blogimage: string, blogdetail: string,
      blogheading: string,website: string, date : object,likes: number, dislikes: number, category: string,access: string, users: object};
  yourname: any;
  private Profile;
